...
class SupplierController extends Controller
{
    ...
    public function index()
    {
        ...
        $supplier = Supplier::join('obats' , 'suppliers.id_obat', '=', 'obats.id')->get();
    ...
    public function store(Request $request)
    {
        ...
        $riwayat_Obats = new Riwayat_obat();
        $riwayat_Obats->type = 'masuk';
        $riwayat_Obats->id_obat = $request->id_obat;
        $riwayat_Obats->jumlah = $request->jumlah;
        $riwayat_Obats->save();
        $obat->save();
